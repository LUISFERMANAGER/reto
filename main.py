...
# Ejemplo de conjunto de datos original
original_dataset = {
    "General": ["Hola", "¿Cómo están?", "Gracias por su atención"],
    "Productos": ["¿Qué productos ofrecen?", "¿Tienen productos nuevos?"]
}

# Ampliar el conjunto de datos original
expanded_dataset = expand_dataset(original_dataset)

# Mostrar el conjunto de datos ampliado
for category, phrases in expanded_dataset.items():
    print(f"{category}:")
